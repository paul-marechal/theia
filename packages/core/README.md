...
- `@theia/core/shared/...`
    ...
    - `@theia/application-package` (from [`@theia/application-package@1.21.0`](https://www.npmjs.com/package/@theia/application-package))
    - `@theia/application-package/lib/api` (from [`@theia/application-package@1.21.0`](https://www.npmjs.com/package/@theia/application-package))
    - `@theia/application-package/lib/environment` (from [`@theia/application-package@1.21.0`](https://www.npmjs.com/package/@theia/application-package))
